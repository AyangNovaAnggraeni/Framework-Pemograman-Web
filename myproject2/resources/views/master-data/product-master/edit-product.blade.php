<x-app-layout>
    ...
    <div class="py-12">
                    ...
                    <div class="container mx-auto mt-5">
                        ...
                        <form action="{{ route('product.update', $product->id) }}" method="POST" class="p-6 bg-white rounded shadow-md">
                            ...
                            <div class="flex justify-end">
                                <button type="submit" class="px-4 py-2 text-white bg-indigo-500 rounded hover:bg-indigo-600 focus:ring-2 focus:ring-indigo-500">
        ...
        <script>
            ...
            // Setelah klik OK → redirect ke halaman index
